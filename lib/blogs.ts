...
,
  ...
  {
    id: 'webp-vs-png-vs-jpeg-image-format-guide',
    title: 'WebP vs PNG vs JPEG: Which Image Format? (2026)',
    description: 'Compare WebP, PNG, and JPEG: file sizes, quality, browser support, and when to use each.',
    seoTitle: 'WebP vs PNG vs JPEG: Image Format Guide | UtilToolkits',
    seoDescription: 'When to use WebP, PNG, or JPEG. Compare file sizes, quality, transparency — convert free in your browser.',
    keywords: ['webp vs png','webp vs jpeg','image format comparison','when to use webp','png vs jpg','best image format for web'],
    date: '2026-06-06',
    updatedDate: '2026-06-06',
    author: 'UtilToolkits',
    category: 'Image Tools',
    relatedTools: ['image-converter','image-compressor','image-resizer'],
    content: '<p><strong>Use WebP</strong> for modern web images, <strong>PNG</strong> for transparency, <strong>JPEG</strong> for email/legacy. Convert free: <a href="/tools/image-converter">Image Converter</a>.</p><h2>File size comparison</h2><table><thead><tr><th>Format</th><th>Size</th><th>Transparency</th></tr></thead><tbody><tr><td>PNG lossless</td><td>3.8 MB</td><td>Yes</td></tr><tr><td>JPEG q85</td><td>420 KB</td><td>No</td></tr><tr><td>WebP q80</td><td>280 KB</td><td>Yes</td></tr></tbody></table>',
  },
  {
    id: 'css-box-shadow-complete-guide',
    title: 'CSS Box Shadow: Complete Guide and Generator (2026)',
    description: 'Learn CSS box-shadow syntax, multiple shadows, inset shadows, and design patterns with a free live generator.',
    seoTitle: 'CSS Box Shadow Guide and Free Generator | UtilToolkits',
    seoDescription: 'Master CSS box-shadow: offset, blur, spread, color, inset. Generate production-ready CSS free.',
    keywords: ['css box shadow','box shadow generator','css box shadow examples','css shadow syntax','inset box shadow'],
    date: '2026-06-06',
    updatedDate: '2026-06-06',
    author: 'UtilToolkits',
    category: 'CSS Tools',
  ...
  {
    id: 'url-slug-seo-guide',
    title: 'URL Slugs and SEO: Generate Clean Keyword-Rich URLs (2026)',
    description: 'What a URL slug is, why it matters for SEO, and how to create clean slugs — with a free generator.',
    seoTitle: 'URL Slug Generator and SEO Guide | UtilToolkits',
    seoDescription: 'Create SEO-friendly slugs: lowercase, hyphenated, keyword-first. Free generator handles Unicode and stop words.',
    keywords: ['url slug generator','what is a url slug','seo url structure','slug generator online','seo friendly urls'],
    date: '2026-06-06',
    updatedDate: '2026-06-06',
    author: 'UtilToolkits',
    category: 'Text Tools',
    relatedTools: ['slug-generator','case-converter','word-counter'],
    content: '<p>A URL slug is the readable part after the last slash: <code>/how-to-format-json</code>. Keep it lowercase, hyphen-separated, 3-5 words, keyword-first.</p><p>Use the <a href="/tools/slug-generator">Slug Generator</a> — handles Unicode, strips stop words, supports batch mode for CSV exports.</p><h2>Common mistakes</h2><ul><li>Uppercase letters or underscores</li><li>Slugs longer than 5 words</li><li>No keywords (e.g. /post-1)</li><li>Changing slugs on ranked pages without a 301 redirect</li></ul>',
  },
  {
    id: 'typescript-interfaces-from-json',
    title: 'Stop Writing TypeScript Interfaces by Hand — Generate from JSON',
    description: 'Automatically generate TypeScript interfaces from JSON: nested objects, arrays, union types, optional fields.',
    seoTitle: 'JSON to TypeScript: Generate Interfaces Automatically | UtilToolkits',
    seoDescription: 'Convert JSON to TypeScript interfaces in seconds. Handles nested objects, arrays, union types. Free, browser-based.',
    keywords: ['json to typescript','generate typescript interfaces from json','typescript interface generator','json to ts online'],
    date: '2026-06-06',
    updatedDate: '2026-06-06',
    author: 'UtilToolkits',
    category: 'Coding Tools',

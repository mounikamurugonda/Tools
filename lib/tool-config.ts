...
export const TOOL_CONFIGS: ToolMetadata[] = [
  ...
  { id: 'readability-score-calculator', name: 'Readability Score', description: 'Calculate readability score of your text.', category: ToolCategory.TEXT },
  ...
  { id: 'video-to-audio-converter', name: 'Video to Audio Converter', description: 'Extract audio from videos.', category: ToolCategory.VIDEO },

...
export const TOOL_CONFIGS: ToolMetadata[] = [
  ...
  { id: 'youtube-thumbnail-downloader', name: 'YouTube Thumbnail Downloader', description: 'Download YouTube video thumbnails.', category: ToolCategory.IMAGE },
  ...
  { id: 'css-triangle', name: 'CSS Triangle Generator', description: 'Generate CSS triangles.', category: ToolCategory.CSS },

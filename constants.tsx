      ...
      faqs: [
        {
          ...
          "answer": "YAML is a human-readable data serialization language. It is often used for configuration files and in applications where data is being stored or transmitted."
        },
        {
        ...
        },
        {
          ...
          "answer": "Yes, this tool validates your YAML syntax before converting it to JSON and will show an error if it is not valid."
        }
      ],
    },
  },
      ...
      faqs: [
        {
          ...
          "answer": "YAML is often preferred for configuration files because it is more human-readable than JSON. This tool allows you to easily convert your JSON data to YAML."
        },
        {
          "question": "Does this tool support all JSON features?",
          "answer": "This tool supports all standard JSON features and will convert them to their corresponding YAML representation."
        },
        {
          "question": "Is my JSON data secure?",
          "answer": "Yes, all the conversion is done in your browser. Your JSON data is not sent to any server, so it remains private."
        }
      ],
    },
  },

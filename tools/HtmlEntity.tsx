    ...
    <ToolContainer title="HTML Entity Encoder/Decoder" details={details} toolId={toolId}>
      <div className="space-y-4">
        ...
        <div className="flex gap-4">
            <button onClick={encode} className="flex-1 py-2 bg-blue-600 text-white rounded">Encode</button>
            <button onClick={decode} className="flex-1 py-2 bg-green-600 text-white rounded">Decode</button>
        </div>
        <div className="relative">
            <textarea readOnly value={output} className="w-full h-40 brand-input bg-gray-50 dark:bg-gray-900" placeholder="Output..." />

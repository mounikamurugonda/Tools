    ...
    <ToolContainer title="Markdown Previewer" details={details} toolId={toolId}>
      <div className="grid md:grid-cols-2 gap-4">
        <div className="flex flex-col relative">
          <label htmlFor="markdown-input" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Markdown Input</label>
          <textarea
            id="markdown-input"
            value={markdown}
          ...
          />
          {markdown && <CopyButton textToCopy={markdown} className="absolute top-8 right-2" />}
        </div>
        <div className="flex flex-col">
          <label htmlFor="markdown-output" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Preview</label>
          <div className="relative">
            ...
            />
            {renderedHtml && <CopyButton textToCopy={renderedHtml} className="absolute top-2 right-2" />}
          </div>
        </div>
      </div>
    </ToolContainer>

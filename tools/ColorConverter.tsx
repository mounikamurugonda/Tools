...
const ColorConverter: React.FC<ToolProps> = () => {
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="flex justify-center items-center">
                    <div className="relative">
                        <div style={{ backgroundColor: hex }} className="w-48 h-48 rounded-full border-4 border-gray-700 shadow-lg"></div>
        ...
        <div>
            ...
            <div className="relative">
                <input
                    ...
                    onChange={onChange}
                    readOnly={readOnly}
                    className="w-full bg-gray-700 border border-gray-600 rounded p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-200 pr-12"
                />
                <button
                    onClick={onCopy}

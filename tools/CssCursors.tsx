  ...
  return (
    <ToolContainer title="CSS Cursor Viewer" details={details} toolId={toolId}>
      <p className="mb-6 text-gray-600 dark:text-gray-400">
        Hover over any box to see the cursor in action. Click to copy the CSS
        value.
      </p>
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
        {CURSORS.map((cursor) => (
          ...
          >
            ...
            <span className="absolute bottom-2 opacity-0 group-hover:opacity-100 text-[10px] text-blue-500">
              Click to copy
            </span>
          </div>
        ))}

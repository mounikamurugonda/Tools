          ...
          {filteredTasks.map((task) => (
            ...
            >
              ...
              <button
                ...
                className="text-gray-500 hover:text-red-500 dark:hover:text-red-400 ml-2"
              >
                <svg
...
const FilterButton: React.FC<{
  ...
  return (
    <button
      onClick={() => set(value)}
      className={`w-1/3 py-1 rounded-md text-sm transition-colors ${current === value ? 'bg-blue-600 text-white' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-300 dark:hover:bg-gray-700'}`}
    >
      {label}
    </button>
  );

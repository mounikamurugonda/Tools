      ...
      <div className="space-y-6">
        <div className="flex justify-center bg-gray-200 dark:bg-gray-700 rounded-lg p-1">
          <button
            ...
            className={`w-1/2 py-2 rounded-md ${mode === 'duration' ? 'bg-blue-600 text-white' : 'hover:bg-gray-300 dark:hover:bg-gray-600'}`}
          >
            Duration Between Dates
          </button>
          <button
            onClick={() => setMode('calculate')}
            className={`w-1/2 py-2 rounded-md ${mode === 'calculate' ? 'bg-blue-600 text-white' : 'hover:bg-gray-300 dark:hover:bg-gray-600'}`}
          >
            Add/Subtract Days
          </button>
        </div>

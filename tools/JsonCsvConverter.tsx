                ...
                <div className="flex justify-center">
                    <div className="bg-gray-100 dark:bg-gray-800 p-1 rounded-lg inline-flex">
                        <button
                            ...
                            className={`px-4 py-2 rounded-md transition-all ${mode === 'json-to-csv' ? 'bg-white dark:bg-gray-700 shadow-sm font-medium text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}
                        >
                            JSON to CSV
                        </button>
                        <button
                            onClick={() => setMode('csv-to-json')}
                            className={`px-4 py-2 rounded-md transition-all ${mode === 'csv-to-json' ? 'bg-white dark:bg-gray-700 shadow-sm font-medium text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400'}`}
                        >
                            CSV to JSON
                        </button>
                    </div>
                    <button onClick={swapMode} className="ml-4 p-2 text-gray-500 hover:text-blue-600" title="Swap Input/Output">

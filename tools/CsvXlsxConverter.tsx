                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <select
                          ...
                          onChange={(e) =>
                            setCsvToXlsxSeparator(e.target.value)
                          }
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div>
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              setXlsxToCsvSeparator(e.target.value)
                            }
                            className="w-full bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none"
                          >
                            <option value=",">Comma (,)</option>
                        ...
                        <div>
                          ...
                          <select
                            value={quoteFields}
                            onChange={(e) =>
                              setQuoteFields(e.target.value as QuoteFields)
                            }
                            className="w-full bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none"
                          >
                      ...
                      <label className="flex items-center gap-3 cursor-pointer">
                        <input
                          ...
                          onChange={(e) =>
                            setReplaceLineBreaks(e.target.checked)
                          }
                          className="h-4 w-4 rounded border-slate-300 text-blue-600 focus:ring-blue-500"
                        />
                        <span className="text-sm font-medium text-slate-700 dark:text-slate-300">
                      ...
                      {replaceLineBreaks && (
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setLineBreakReplacement(e.target.value)
                            }
                            className="w-full bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 rounded-lg p-2.5 focus:ring-2 focus:ring-blue-500 outline-none"
          ...
          {(uploadedFile || isPasted) && (
            <div className="mt-8 flex justify-center">
              <button
                ...
                disabled={
                  isProcessing ||
                  (conversionType === 'xlsx-to-csv' && !csvOutput)
                }
              ...
              >
                {isProcessing ? (
                  ...
                  <>
                    ...
                    <span>
                      Download{' '}
                      {outputFormats.find((f) => f.value === outputFormat)
                        ?.label || 'File'}
                    </span>
                  </>
                )}

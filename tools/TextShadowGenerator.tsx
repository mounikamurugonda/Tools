            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                    <div className="space-y-4">
                        ...
                        <RangeSlider label="Vertical Offset (px)" value={vOffset} setValue={setVOffset} min={-20} max={20} />
                        <RangeSlider label="Blur Radius (px)" value={blur} setValue={setBlur} min={0} max={20} />
                    ...
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Text Shadow Tips</h4>
                        <div className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                            ...
                            <p>• <strong>Multiple shadows:</strong> Use comma-separated values</p>
                        </div>
                    </div>
                </div>
...
const RangeSlider: React.FC<RangeSliderProps> = ({ label, value, setValue, min = -20, max = 20, step = 1 }) => (
    <div>

        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded p-2 mb-2 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <input
              type="text"
              value={bottomText}
          ...
          <button
            ...
            disabled={!image}
            className="w-full px-4 py-3 bg-green-600 hover:bg-green-700 text-white rounded font-bold disabled:bg-gray-500 dark:disabled:bg-gray-600 disabled:cursor-not-allowed"
          >
            3. Download Meme
          </button>
        </div>

    ...
    <ToolContainer title="Roman Numeral Converter" details={details} toolId={toolId}>
      <div className="grid md:grid-cols-2 gap-8 items-center max-w-2xl mx-auto">
        <div className="space-y-2">
            <label className="text-xl font-bold block text-center">Decimal Number</label>
            <input 
                type="number" 
                value={number} 
        ...
        <div className="flex justify-center text-gray-400">
            <svg className="w-8 h-8 md:rotate-0 rotate-90" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4" /></svg>
        </div>
        <div className="space-y-2">
            <label className="text-xl font-bold block text-center">Roman Numeral</label>
            <input 
                type="text" 
                value={roman} 

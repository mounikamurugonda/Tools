    ...
    <ToolContainer title="Word & Character Counter">
      <div className="space-y-4">
        <textarea
          ...
          className="w-full h-48 bg-gray-700 border border-gray-600 rounded p-2 focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-200"
        />
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
          ...
          <div className="bg-gray-700 p-4 rounded-lg">
            ...
            <div className="text-gray-400">Sentences</div>
          </div>
          <div className="bg-gray-700 p-4 rounded-lg">

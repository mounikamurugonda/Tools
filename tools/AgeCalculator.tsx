      ...
      <div className="space-y-8 max-w-2xl mx-auto">
        <div className="grid md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="date" value={dob} onChange={e => setDob(e.target.value)} className="brand-input" style={{ colorScheme: 'dark' }} />
            </div>
            <div>
                <label className="block text-sm font-medium mb-1">Calculate Age At</label>
                <input type="date" value={today} onChange={e => setToday(e.target.value)} className="brand-input" style={{ colorScheme: 'dark' }} />
            </div>
        </div>
        ...
        <div className="bg-blue-600 text-white rounded-2xl p-8 text-center shadow-lg">
            ...
            <div className="flex justify-center gap-6 text-xl">
                <span><span className="font-bold">{age.months}</span> months</span>
                <span><span className="font-bold">{age.days}</span> days</span>
            </div>
        </div>

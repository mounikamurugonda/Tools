  ...
  return (
    <div className="brand-container-narrow brand-section prose dark:prose-invert max-w-none">
      ...
      <section>
        ...
        <p>
          By accessing the website at UtilToolkits, you are agreeing to be bound
      ...
      <section>
        ...
        <ol>
          <li>
            ...
            materials (information or software) on UtilToolkits&apos; website
          ...
          <li>
            ...
            these restrictions and may be terminated by UtilToolkits at any
      ...
      <section>
        ...
        <p>
          The materials on UtilToolkits&apos; website are provided on an
          &apos;as is&apos; basis. UtilToolkits makes no warranties, expressed
        ...
        <p>
          Further, UtilToolkits does not warrant or make any representations
      ...
      <section>
        ...
        <p>
          In no event shall UtilToolkits or its suppliers be liable for any
          damages (including, without limitation, damages for loss of data or
          profit, or due to business interruption) arising out of the use or
          inability to use the materials on UtilToolkits&apos; website, even if
          UtilToolkits or a UtilToolkits authorized representative has been
      ...
      <section>
        ...
        <p>
          ...
          technical, typographical, or photographic errors. UtilToolkits does
          not warrant that any of the materials on its website are accurate,
          complete or current. UtilToolkits may make changes to the materials
          contained on its website at any time without notice. However
          UtilToolkits does not make any commitment to update the materials.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          UtilToolkits has not reviewed all of the sites linked to its website
          and is not responsible for the contents of any such linked site. The
          inclusion of any link does not imply endorsement by UtilToolkits of
      ...
      <section>
        ...
        <p>
          UtilToolkits may revise these terms of service for its website at any
      ...
      <section>
        ...
        <p>
          ...
          with the laws of the location of the website owner and you irrevocably

                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <h2 className="text-3xl md:text-5xl font-bold mb-6 text-slate-900 dark:text-white">
                            Built for people who <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">teach code</span>
                        </h2>
                        <p className="text-lg text-slate-600 dark:text-slate-400">
                            Whether you have 10 followers or 1 million, CodeCast helps you produce professional content faster.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <div key={i} className="group p-8 rounded-3xl bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 hover:shadow-xl dark:hover:shadow-2xl dark:hover:shadow-purple-900/10 transition-all duration-300 hover:-translate-y-1">
                                <div className={`w-14 h-14 rounded-2xl ${item.color} flex items-center justify-center text-2xl mb-6 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300 shadow-sm`}>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-300 mt-6">
                            Transform your coding content from &quot;hard to follow&quot; to <span className="text-slate-900 dark:text-white font-bold">studio quality</span> in seconds.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
                        ...
                        <div className="flex flex-col items-center justify-center gap-2 text-slate-400 dark:text-slate-500">
                            ...
                            <div className="p-3 rounded-full bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-xl">
                                <span className="block transform rotate-90 lg:rotate-0 text-slate-600 dark:text-white">➔</span>
                            </div>
                    ...
                    <div className="mt-16 text-center animate-fade-in-up">
                        <p className="text-xl md:text-2xl font-medium text-slate-500 dark:text-slate-400">
                            Viewers lose focus. <span className="mx-2 text-slate-300 dark:text-slate-700">|</span> Creators lose engagement.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-3xl mx-auto mb-20">
                        ...
                        <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                            CodeCast lets you transform plain code into engaging visual demos that people can watch, understand, and remember — perfect for tutorials, short videos, and documentation.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all duration-300">
                            ...
                            <p className="text-slate-600 dark:text-slate-400 mb-6 min-h-[48px]">
                                Paste your HTML, CSS, or JavaScript and let CodeCast automatically animate the typing.
                            </p>
                            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-500">
                                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> No manual typing needed</li>
                                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Smooth, realistic animation</li>
                            </ul>
                        </div>
                        ...
                        <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all duration-300">
                            ...
                            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-500">
                                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Optional keyboard sound</li>
                                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Adjustable typing speed</li>
                            </ul>
                        </div>
                        ...
                        <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:shadow-lg transition-all duration-300">
                            ...
                            <ul className="space-y-2 text-sm text-slate-500 dark:text-slate-500">
                                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> High-res export</li>
                                <li className="flex items-center gap-2"><CheckCircle size={16} className="text-green-500" /> Custom themes & fonts</li>
                            </ul>
                        </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-start">
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-600 dark:text-slate-400 mb-6">
                                        Show code and output together in a realistic preview layout. Write code on one side, see results on the other — live.
                                    </p>
                                    <div className="flex gap-4">
                                        <span className="px-3 py-1 rounded-full bg-slate-200 dark:bg-slate-800 text-xs font-semibold">HTML/CSS/JS</span>
                                        <span className="px-3 py-1 rounded-full bg-slate-200 dark:bg-slate-800 text-xs font-semibold">Mobile Demo</span>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-center">
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-600 dark:text-slate-400">
                                        Whether you’re teaching HTML, explaining UI concepts, or showcasing snippets, CodeCast helps your code speak visually.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 relative max-w-7xl mx-auto">
                        ...
                        {[
                            ...
                            },
                            {
                                ...
                                icon: Code2,
                                title: 'Add your code',
                                items: ['Paste or write code', 'Live syntax highlighting', 'Distraction-free editor'],
                            ...
                            <div key={idx} className="flex-1 relative z-10 group">
                                <div className="flex flex-col items-center bg-white dark:bg-slate-900 p-6 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-xl dark:hover:shadow-2xl dark:hover:shadow-blue-900/10 transition-all duration-300 h-full">
                                    ...
                                    {/* Icon Circle */}
                                    <div className={`w-16 h-16 rounded-2xl ${item.color} flex items-center justify-center mb-6 shadow-sm group-hover:scale-110 transition-transform`}>
                                        <item.icon size={28} />
                                    </div>
                                    ...
                                    <ul className="space-y-2 w-full">
                                        {item.items.map((subItem, i) => (
                                            <li key={i} className="flex items-center gap-2 text-sm text-slate-600 dark:text-slate-400 justify-center text-center">
            ...
            <section className="py-24 bg-white dark:bg-slate-950">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        ...
                        <h3 className="text-xl text-blue-600 dark:text-blue-400 font-medium">Built for modern code creators</h3>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-20">
                        {[
                            ...
                            <div key={i} className="flex flex-col p-6 rounded-3xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:hover:border-slate-700 hover:shadow-lg transition-all duration-300">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {item.tags.map((tag, t) => (
                                        <span key={t} className="px-2.5 py-1 rounded-md text-xs font-semibold bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
                    ...
                    <div className="bg-slate-50 dark:bg-slate-900/50 rounded-3xl p-8 md:p-12 text-center max-w-4xl mx-auto border border-slate-100 dark:border-slate-800">
                        <h4 className="text-xl font-bold mb-6 text-slate-900 dark:text-white">Who Uses CodeCast?</h4>
                        <div className="flex flex-wrap justify-center gap-3 md:gap-6 mb-8">
                            {['Frontend Developers', 'Educators & Mentors', 'Content Creators', 'Indie Hackers'].map((role, i) => (
                ...
                <div className="container mx-auto px-4 relative z-10">
                    <div className="max-w-5xl mx-auto relative group">
                        ...
                        <div className="relative rounded-[2rem] bg-slate-900 border border-slate-800 p-8 md:p-16 text-center overflow-hidden">
                            ...
                            <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'linear-gradient(#334155 1px, transparent 1px), linear-gradient(to right, #334155 1px, transparent 1px)', backgroundSize: '40px 40px' }}></div>
                            ...
                            <div className="relative z-10 flex flex-col items-center">
                                ...
                                <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">
                                    Start creating <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">better code demos</span>
                                </h2>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 w-full justify-center items-center">
                                    ...
                                    <Link href="/product/code-cast/animate" className="text-slate-400 hover:text-white font-medium px-6 py-4 flex items-center gap-2 transition-colors">

...
export const metadata: Metadata = {
    ...
    description: 'The #1 tool for developer content creators. Create studio-quality code animations, beautiful screenshots, and viral coding videos for Instagram, TikTok, and YouTube in seconds.',
    keywords: [
        'code animation',
        'code to video',
        'syntax highlighter',
    ...
    openGraph: {
        ...
        description: 'Stop posting static screenshots. Create engaging, animated code demos that go viral. Trusted by top developer creators.',
        type: 'website',
        images: [
            {
    ...
    twitter: {
        ...
        description: 'Turn your code into engaging videos for socials. Auto-animate typing, create studio-quality visuals, and boost engagement.',
    },
};

        ...
        <div className="prose dark:prose-invert max-w-none">
          <div className="text-center mb-12">
            ...
            <p className="brand-subheading">
              A developer&apos;s hobby project aimed at building the most practical collection of
              browser-based tools.
            </p>
          </div>
          ...
          <section>
            ...
            <p>
              ...
              searching for simple tools—like a JSON formatter or an image compressor—only to land
              on sites buried in ads, requiring logins, or uploading my private data to a server
              just to process a few bytes.
            </p>
            <p>
              ...
              those utilities in one clean, fast, and private place.
            </p>
          </section>
          ...
          <section>
            ...
            <ul>
              <li>
                <strong>Real-time Speed:</strong> Everything runs locally. No API latency.
              </li>
              <li>
                <strong>100% Privacy:</strong> Your data (images, code, text) never leaves your
                browser.
              </li>
              <li>
                <strong>No Bloat:</strong> Just the tool, exactly when you need it.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              The goal isn&apos;t just 10 or 20 tools. I plan to add{' '}
              <strong>hundreds of tools</strong> to cover every possible developer need. But I
              can&apos;t guess them all.
            </p>
            <p>
              <strong>This project thrives on user requests.</strong> If you need a specific
              converter, generator, or calculator that doesn&apos;t exist here yet, let me know. I
              build what you ask for. This allows the toolkit to grow naturally based on real-world
              problems developers are facing right now.
            </p>
          </section>

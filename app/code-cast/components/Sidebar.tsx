...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div 
      className={`
        h-full bg-gray-950 border-r border-gray-800 flex-shrink-0 z-20 
    ...
    >
      <div className="w-80 h-full flex flex-col overflow-hidden">
        {/* Header */}
        <div className="h-16 flex items-center justify-between px-6 border-b border-gray-800 shrink-0 bg-gray-950">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
          ...
          <div className="space-y-3">
             ...
             <input
               ...
               className="w-full bg-gray-900 border border-gray-800 rounded-lg p-3 text-xs text-gray-300 focus:outline-none focus:border-blue-500 placeholder-gray-700 transition-colors"
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="flex items-center gap-1 text-[10px] bg-gray-800 hover:bg-gray-700 text-gray-300 px-2 py-1 rounded transition-colors disabled:opacity-50"
            ...
            <div className="flex p-1 bg-gray-900 rounded-lg border border-gray-800">
              {['html', 'css', 'js'].map((t) => (
                <button
                  ...
                  className={`flex-1 py-1.5 text-[10px] font-bold uppercase rounded-md transition-all ${activeTab === t ? 'bg-gray-800 text-white shadow-sm border border-gray-700' : 'text-gray-500 hover:text-gray-400'}`}
                >
                  {t}
                </button>
              ))}
            ...
            <textarea 
              ...
              onPaste={handlePaste}
              className="w-full h-64 bg-gray-900 border border-gray-800 rounded-lg p-3 text-xs font-mono text-gray-300 focus:outline-none focus:border-blue-500 resize-none placeholder-gray-700 leading-relaxed whitespace-pre-wrap break-words"
          ...
          <div className="space-y-4 pt-4 border-t border-gray-800">
                ...
                {BACKGROUND_PRESETS.map((bg) => (
                   <button
                     ...
                     className={`
                       ...
                       ${config.background === bg.id ? 'border-white shadow-lg scale-105' : 'border-transparent hover:border-gray-500'}
                     `}
                     title={bg.label}
                   >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-gray-900 text-white text-sm rounded-md border border-gray-700 px-3 py-2 outline-none focus:border-blue-500"
                >
                  {EDITOR_THEMES.map((t) => (
            ...
            <div className="space-y-2">
              <span className="text-sm text-gray-400">Canvas Size</span>
              <select
          ...
          <div className="space-y-4 pt-4 border-t border-gray-800">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between mb-2">
                 <span className="text-sm text-gray-400">Audio Profile</span>
                 <button 
                  onClick={() => setConfig(p => ({ ...p, soundEnabled: !p.soundEnabled }))}
                  className={`w-10 h-5 rounded-full relative transition-colors ${config.soundEnabled ? 'bg-blue-500' : 'bg-gray-700'}`}
                >
              ...
              <div className={`relative transition-opacity ${config.soundEnabled ? 'opacity-100' : 'opacity-40 pointer-events-none'}`}>
                 <select 
                    ...
                    className="w-full bg-gray-900 text-white text-sm rounded-md border border-gray-700 px-3 py-2 outline-none focus:border-blue-500 appearance-none"
            ...
            <div className="flex items-center justify-between bg-gray-900 p-3 rounded-lg border border-gray-700 mt-4">
              ...
              <button 
                ...
                className={`w-10 h-5 rounded-full relative transition-colors ${config.showCursor ? 'bg-blue-500' : 'bg-gray-700'}`}
              >

            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                        Can&apos;t find the tool you need? Let us know and we&apos;ll consider adding it to UtilToolkits!
                    </p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 sm:p-8 shadow-sm">
                    <form onSubmit={onSubmit} className="space-y-6">
                        ...
                        {/* Status Message */}
                        {result && (
                            <div className={`p-4 rounded-lg text-sm font-medium ${result === "Form Submitted Successfully"

          ...
          <div className="hidden md:flex items-center gap-1">
            <nav className="flex items-center gap-1 mr-4">
              <Link
                href="/"
                onClick={closeAllMenus}
                className="px-3 py-2 text-sm font-medium text-light-text dark:text-dark-text hover:text-accent rounded-md transition-colors"
              >
                Home
              </Link>
              <Link
        ...
        <div className="fixed inset-0 bg-light-background dark:bg-dark-background z-[60] animate-fade-in md:hidden flex flex-col">
          <div className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700 h-20">
            ...
            <button
              ...
              className="p-2 rounded-full text-light-text dark:text-dark-text hover:bg-gray-100 dark:hover:bg-gray-800"
            >
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            <Link
              href="/"
              onClick={closeAllMenus}
              className="block px-4 py-3 text-lg font-medium text-light-text dark:text-dark-text hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg"
            >
              Home
            </Link>
            <Link
